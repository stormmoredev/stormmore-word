            ...
            <div class="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                    <div class="flex h-16 shrink-0 items-center">
                        <img class="h-8 w-auto" src="{{ url('/public/images/storm-cms.png') }}" />
                    </div>
                            ...
                            <li>
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li>
                                        ...
                                        <a href="/admin/articles" class="group flex gap-x-3 rounded-md bg-gray-50 p-2 text-sm font-semibold leading-6 text-indigo-600">
            ...
            <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    <li>
                        <ul role="list" class="-mx-2 space-y-1">
                            <li>
                                <a href="{{ url('/admin/articles') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                                    <img src="{{ url('/public/images/icons/pen.svg') }}" class="size-6" />
                                    {{ _ Articles }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/admin/forum') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700">
                            ...
                            <li>
                                <a href="{{ url('/admin/users') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                                    <img src="{{ url('/public/images/icons/users.svg') }}" class="size-6"/>
                                    {{ _ Users }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/admin/sessions') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <li>
                                <a href="{{ url('/admin/settings') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
